...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/geometry/CGL_3_A.test.cpp\"\n// verification-helper:\
    ...
    \ main(){\n  return 0;\n}\n#endif\n#line 7 \"test/aoj/geometry/CGL_3_A.test.cpp\"\
    \n#undef call_from_test\n\n//Area of Polygon\nsigned main(){\n  int n;\n  cin>>n;\n\
    \  Polygon ps(n);\n  cin>>ps;\n  cout<<fixed<<setprecision(1)<<area(ps)<<endl;\n\
    \  return 0;\n}\n"
  code: "// verification-helper: PROBLEM http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_A\n\
    #include<bits/stdc++.h>\nusing namespace std;\n\n#define call_from_test\n#include\
  ...
  verifiedWith: []
documentation_of: test/aoj/geometry/CGL_3_A.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/geometry/CGL_3_A.test.cpp
- /verify/test/aoj/geometry/CGL_3_A.test.cpp.html
