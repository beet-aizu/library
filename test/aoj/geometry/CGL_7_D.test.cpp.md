...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/geometry/CGL_7_D.test.cpp\"\n// verification-helper:\
    \ PROBLEM http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_D\n//\
    ...
    \ main(){\n  ECR002_D();\n  return 0;\n}\n#endif\n#line 9 \"test/aoj/geometry/CGL_7_D.test.cpp\"\
    \n#undef call_from_test\n\n\n//getCrossPointCL\nsigned main(){\n  Circle c;\n\
    \  int q;\n  cin>>c>>q;\n  while(q--){\n    Line l;\n    cin>>l;\n    auto pp=getCrossPointCL(c,l);\n\
    \    if(pp.size()==1u) pp.emplace_back(pp[0]);\n    if(pp[1]<pp[0]) swap(pp[0],pp[1]);\n\
    \    cout<<pp[0]<<\" \"<<pp[1]<<endl;\n  }\n  return 0;\n}\n"
  code: "// verification-helper: PROBLEM http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_D\n\
    // verification-helper: ERROR 0.000001\n\n#include<bits/stdc++.h>\nusing namespace\
  ...
  verifiedWith: []
documentation_of: test/aoj/geometry/CGL_7_D.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/geometry/CGL_7_D.test.cpp
- /verify/test/aoj/geometry/CGL_7_D.test.cpp.html
