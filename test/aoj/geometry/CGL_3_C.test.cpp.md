...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/geometry/CGL_3_C.test.cpp\"\n// verification-helper:\
    \ PROBLEM http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_C\n#include<bits/stdc++.h>\n\
    ...
    \ main(){\n  return 0;\n}\n#endif\n#line 7 \"test/aoj/geometry/CGL_3_C.test.cpp\"\
    \n#undef call_from_test\n\n//contains\nsigned main(){\n  int n;\n  cin>>n;\n \
    \ Polygon ps(n);\n  cin>>ps;\n  int q;\n  cin>>q;\n  while(q--){\n    Point r;\n\
    \    cin>>r;\n    cout<<contains(ps,r)<<endl;\n  }\n  return 0;\n}\n"
  code: "// verification-helper: PROBLEM http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_C\n\
    #include<bits/stdc++.h>\nusing namespace std;\n\n#define call_from_test\n#include\
  ...
  verifiedWith: []
documentation_of: test/aoj/geometry/CGL_3_C.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/geometry/CGL_3_C.test.cpp
- /verify/test/aoj/geometry/CGL_3_C.test.cpp.html
