...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/geometry/CGL_1_C.test.cpp\"\n// verification-helper:\
    ...
    \ main(){\n  return 0;\n}\n#endif\n#line 7 \"test/aoj/geometry/CGL_1_C.test.cpp\"\
  ...
  code: "// verification-helper: PROBLEM http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_C\n\
    ...
    \ cout<<\"COUNTER_CLOCKWISE\"<<endl;\n    if(t==CCW_CLOCKWISE) cout<<\"CLOCKWISE\"\
    <<endl;\n    if(t==CCW_ONLINE_BACK) cout<<\"ONLINE_BACK\"<<endl;\n    if(t==CCW_ONLINE_FRONT)\
    \ cout<<\"ONLINE_FRONT\"<<endl;\n    if(t==CCW_ON_SEGMENT) cout<<\"ON_SEGMENT\"\
    <<endl;\n  }\n  return 0;\n}\n"
  dependsOn:
  - geometry/geometry.cpp
...
layout: document
redirect_from:
- /verify/test/aoj/geometry/CGL_1_C.test.cpp
- /verify/test/aoj/geometry/CGL_1_C.test.cpp.html
