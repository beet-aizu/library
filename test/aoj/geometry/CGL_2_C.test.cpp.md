...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/geometry/CGL_2_C.test.cpp\"\n// verification-helper:\
    \ PROBLEM http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_C\n//\
    ...
    \ main(){\n  ECR002_D();\n  return 0;\n}\n#endif\n#line 9 \"test/aoj/geometry/CGL_2_C.test.cpp\"\
    \n#undef call_from_test\n\n\n//cross point\nsigned main(){\n  int q;\n  cin>>q;\n\
    \  while(q--){\n    Point p0,p1,p2,p3;\n    cin>>p0>>p1>>p2>>p3;\n    cout<<getCrossPointSS(Segment(p0,p1),Segment(p2,p3))<<endl;\n\
    \  }\n  return 0;\n}\n"
  code: "// verification-helper: PROBLEM http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_C\n\
    // verification-helper: ERROR 0.00000001\n\n#include<bits/stdc++.h>\nusing namespace\
  ...
  verifiedWith: []
documentation_of: test/aoj/geometry/CGL_2_C.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/geometry/CGL_2_C.test.cpp
- /verify/test/aoj/geometry/CGL_2_C.test.cpp.html
