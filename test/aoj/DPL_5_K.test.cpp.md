...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/DPL_5_K.test.cpp\"\n// verification-helper: PROBLEM\
    \ http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_K\n\n#include<bits/stdc++.h>\n\
  ...
  verifiedWith: []
documentation_of: test/aoj/DPL_5_K.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/DPL_5_K.test.cpp
- /verify/test/aoj/DPL_5_K.test.cpp.html
